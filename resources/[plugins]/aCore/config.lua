robberiesConfiguration = {
    ...
    items = {
        ["TV"] = { name = "Téléviseur", resellerValue = 800, timeToTake = 10 },
        ["CLOTHS"] = { name = "Vêtements", resellerValue = 500, timeToTake = 15 },
        ["CLOTHSRICHE"] = { name = "Vêtements de Luxe", resellerValue = 900, timeToTake = 15 },
        ["ECOMP"] = { name = "Composants électroniques", resellerValue = 100, timeToTake = 4 },
        ["ORANGE"] = { name = "Fruits", resellerValue = 500, timeToTake = 2 },
        ["TELEPHONE"] = { name = "iPhone", resellerValue = 900, timeToTake = 4 },
        ["PORNO"] = { name = "Magazine Pornographique", resellerValue = 500, timeToTake = 1 },
        ["PARFUM"] = { name = "Parfum Channel", resellerValue = 500, timeToTake = 3 },
        ["TV4K60FPS"] = { name = "TV 4K 60FPS", resellerValue = 600, timeToTake = 15 },
        ["BOITEBIJOUX"] = { name = "Boite a Bijoux", resellerValue = 600, timeToTake = 20 },
        ["PCPORTABLE"] = { name = "Asus Rog 144Hz", resellerValue = 350, timeToTake = 10 },
        ["TABLEAU"] = { name = "Tableau Pablo Picasso", resellerValue = 1000, timeToTake = 10 },
        ["ECRANMAC"] = { name = "Ecran Mac", resellerValue = 400, timeToTake = 8 },
        ["JAGUAR"] = { name = "Jaguar", resellerValue = 240, timeToTake = 5 },
        ...
        ["PEINTURE"] = { name = "Peinture", resellerValue = 240, timeToTake = 5 },
        ["CHEVRE"] = { name = "Chevre Mécanique", resellerValue = 350, timeToTake = 10 },
...
bijouterie = {
    ...
    items = {
        ["TV"] = {name = "Téléviseur", resellerValue = 250, timeToTake = 30},
        ["CLOTHS"] = {name = "Vêtements", resellerValue = 850, timeToTake = 15},
        ["CLOTHSRICHE"] = {name = "Vêtements de Luxe", resellerValue = 250, timeToTake = 15},
        ...
        ["TV4K60FPS"] = {name = "TV 4K 60FPS", resellerValue = 480, timeToTake = 45},
        ["BOITEBIJOUX"] = {name = "Boite a Bijoux", resellerValue = 100, timeToTake = 20},
        ["PCPORTABLE"] = {name = "Asus Rog 144Hz", resellerValue = 650, timeToTake = 10},
        ["TABLEAU"] = {name = "Tableau Pablo Picasso", resellerValue = 170, timeToTake = 30},
        ...
        ["DEVICE"] = {name = "Device", resellerValue = 150, timeToTake = 15},
        ...
        ["BILLET1"] = {name = "Pile de Cash", resellerValue = 180, timeToTake = 10},
        ...
        ["DIAMAND"] = {name = "Diamand", resellerValue = 350, timeToTake = 2},
        ["BIJOUX"] = {name = "Bijoux", resellerValue = 550, timeToTake = 2},
    },
