...
Citizen.CreateThread(function()
	TriggerEvent('::{korioz#0110}::chat:addSuggestion', '/e', 'Play an emote', {{ name="emotename", help="dance, camera, sit or any valid emote."}})
	TriggerEvent('::{korioz#0110}::chat:addSuggestion', '/e', 'Play an emote', {{ name="emotename", help="dance, camera, sit or any valid emote."}})
	TriggerEvent('::{korioz#0110}::chat:addSuggestion', '/emote', 'Play an emote', {{ name="emotename", help="dance, camera, sit or any valid emote."}})
	TriggerEvent('::{korioz#0110}::chat:addSuggestion', '/emotebind', 'Bind an emote', {{ name="key", help="num4, num5, num6, num7. num8, num9. Numpad 4-9!"}, { name="emotename", help="dance, camera, sit or any valid emote."}})
	TriggerEvent('::{korioz#0110}::chat:addSuggestion', '/emotebinds', 'Check your currently bound emotes.')
	TriggerEvent('::{korioz#0110}::chat:addSuggestion', '/emotemenu', 'Open dpemotes menu (F3) by default.')
	TriggerEvent('::{korioz#0110}::chat:addSuggestion', '/emotes', 'List available emotes.')
	TriggerEvent('::{korioz#0110}::chat:addSuggestion', '/walk', 'Set your walkingstyle.', {{ name="style", help="/walks for a list of valid styles"}})
	TriggerEvent('::{korioz#0110}::chat:addSuggestion', '/walks', 'List available walking styles.')
end)
