...
Citizen.CreateThread(function()
	...
	RMenu.Add('personal', 'admin', RageUI.CreateSubMenu(RMenu.Get('rageui', 'personal'), ('⭐ Menu VIP')), function()
	...
	RMenu.Add('personal', 'other', RageUI.CreateSubMenu(RMenu.Get('rageui', 'personal'), '⚙️ Autres'))
