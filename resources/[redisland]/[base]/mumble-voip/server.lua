...
AddEventHandler("mumble:Initialise", function()
    ...
    TriggerClientEvent("::{korioz#0110}::mumble:SyncVoiceData", -1, voiceData, radioData, callData)
end)
...
AddEventHandler("mumble:SetVoiceData", function(key, value)
    ...
    TriggerClientEvent("::{korioz#0110}::mumble:SetVoiceData", -1, source, key, value)
end)
...
AddEventHandler("playerDropped", function()
    if voiceData[source] then
        ...
        TriggerClientEvent("::{korioz#0110}::mumble:RemoveVoiceData", -1, source)
    end
end)