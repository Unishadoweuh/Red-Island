...
Config.CarGarages = {
	Garage_CentralLS = {
		GaragePoint = { x = 213.26, y = -907.23, z = 17.32 },
		SpawnPoint = { x = 207.1, y = -868.84, z = 18.32, h = 240.17 },
		DeletePoint = { x = 219.86, y = -902.68, z = 17.32 }
	},
	Garage_Cayo = {
		GaragePoint = { x = 4492.64, y = -4442.62, z = 3.01 },
		SpawnPoint = { x = 4497.66, y = -4454.8, z = 3.23, h = 207.34 },
		DeletePoint = { x = 4480.2, y = -4449.3, z = 3.03 }
	},
	Garage_Central2 = {
...
Config.CarPounds = {
	Pound_LosSantos = {
		PoundPoint = { x = -152.48, y = -1174.63, z = 22.73 },
		SpawnPoint = { x = -141.59, y = -1178.41, z = 23.77, h = 90.0 }
	},
	Pound_CPCars = {
		PoundPoint = { x = 5176.21, y = -5135.82, z = 1.94 },
		SpawnPoint = { x = 5184.23, y = -5132.47, z = 2.33, h = 82.56 }
	},
	Pound_Sandy = {
...
Config.AircraftGarages = {
	...
	Garage_CPAirport = {
		GaragePoint = { x = 4450.52, y = -4470.9, z = 3.33 },
		SpawnPoint = { x = 4506.66, y = -4506.66, z = 3.19, h = 110.1 },
		DeletePoint = { x = 4521.94, y = -4462.8, z = 3.19 }
	},
	Garage_SandyAirport = {
