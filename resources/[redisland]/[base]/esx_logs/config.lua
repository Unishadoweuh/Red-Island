...
Config.username = GetConvar("servername", "Magic Collective") 							-- Bot Username
Config.avatar = "https://i.imgur.com/syldXje.png"			-- Bot Avatar
Config.communtiyName = "Red-Island"					-- Icon top of the Embed
Config.communtiyLogo = "https://i.imgur.com/syldXje.png"		-- Icon top of the Embed
...
-- It used Decimal color codes witch you can get and convert here: discord.gg/fNcNfMJyhu
