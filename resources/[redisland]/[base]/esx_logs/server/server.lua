Config.webhooks = {
	all = "https://discordapp.com/api/webhooks/851109796718313472/JxTfmMacquKIytBNw7WEzyHPdTZja7nPQsOxaO7EZhtNVsCCIPlbFYCxhCaqldPXePMQ",
	chat = "https://discordapp.com/api/webhooks/854431655828914202/vOzQpWFobIJ_EvL52ZexHdpfq5DSSN4QWO8vsGkH0TumiTyDkBn-hOFMKyG0M5qDy-2h",
	joins = "https://discordapp.com/api/webhooks/854431554008121364/CpeYzrp1eLIA5DG_nh7QEkcGOOC2m5x7wGIl87E_xTTuQDhJDLPOjaT0i1tQW-05YKeO",
	leaving = "https://discordapp.com/api/webhooks/854431554008121364/CpeYzrp1eLIA5DG_nh7QEkcGOOC2m5x7wGIl87E_xTTuQDhJDLPOjaT0i1tQW-05YKeO",
	deaths = "https://discordapp.com/api/webhooks/854432351487655987/uaGslcqTETPvECbf1j-rDzc5yp53nlaiRsT8vGwQxXpb66FzWEBfiH35jGNI-RiziNQZ",
	shooting = "https://discordapp.com/api/webhooks/854432351487655987/uaGslcqTETPvECbf1j-rDzc5yp53nlaiRsT8vGwQxXpb66FzWEBfiH35jGNI-RiziNQZ",
...
function discordLog(message, color, channel)
  if Config.AllLogs then
	PerformHttpRequest(Config.webhooks["all"], function(err, text, headers) end, 'POST', json.encode({username = Config.username, embeds = {{["color"] = color, ["author"] = {["name"] = Config.communtiyName,["icon_url"] = Config.communtiyLogo}, ["description"] = "".. message .."",["footer"] = {["text"] = "© ".. GetConvar("discordinvite", "Magic Collective") .." - "..os.date("%x %X %p"),["icon_url"] = "https://media.discordapp.net/attachments/776315529173532682/777020972628312104/RRP_Logo.gif",},}}, avatar_url = Config.avatar}), { ['Content-Type'] = 'application/json' })
  end
	PerformHttpRequest(Config.webhooks[channel], function(err, text, headers) end, 'POST', json.encode({username = Config.username, embeds = {{["color"] = color, ["author"] = {["name"] = Config.communtiyName,["icon_url"] = Config.communtiyLogo}, ["description"] = "".. message .."",["footer"] = {["text"] = "© ".. GetConvar("discordinvite", "Magic Collective") .." - "..os.date("%x %X %p"),["icon_url"] = "https://media.discordapp.net/attachments/776315529173532682/777020972628312104/RRP_Logo.gif",},}}, avatar_url = Config.avatar}), { ['Content-Type'] = 'application/json' })
end
